...
$url = "https://rjohnston80.webhosting3.eeecs.qub.ac.uk/adminapi/?function=allguestparking&adminusername=".$adminUsername."&API-KEY=" . $APIKey;
$curl = curl_init($url);
...
<html>
  ...
  <body class="sidebar-is-reduced">
    <header class="l-header">
      <div class="l-header__inner clearfix">
        ...
        <h2>Admin Guest Parking Logs</h2>
      </div>
    </header>
    <div class="l-sidebar">
      <div class="logo">
      ...
      <div class="l-sidebar__content">
        ...
        <ul class="u-list">
                    <li class="c-menu__item has-submenu" onclick="javascript:window.location.href = ('admin.php');" title="Home">
                        <div class="c-menu__item__inner"><i class="fa fa-home"></i>
                            <div class="c-menu-item__title" ><span>Admin Dashboard</span></div>
                        </div>
                    </li>
                    <li class="c-menu__item has-submenu" onclick="javascript:window.location.href = ('adminparkinglogs.php');" title="parkinlogs">
                        <div class="c-menu__item__inner"><i class="fa fa-history"></i>
                            <div class="c-menu-item__title"><span>Parking Logs</span></div>
                        </div>
                    <li class="c-menu__item is-active" onclick="javascript:window.location.href = ('adminguestparkinglogs.php');"  title="Guestlogs">
                        <div class="c-menu__item__inner"><i class="fa fa-history"></i>
  ...
  <main class="l-main">
    <div class="content-wrapper content-wrapper--with-bg">
        <div class="page-content">Please find all customer guest parking history below. Photos of parking session entry and exit are available to access.</em>
        <?php $total = 0;
          if (is_array($rows)==0) { echo "<h4>There is no current guest parking history, once guests park you will see all parking logs here. </h4>"; }
          else {
          ...
          for ($x = 0; $x <= sizeof($rows)-1; $x++) {
            ...
            $hoursused = round(($rows[$x]['outTime'] - $rows[$x]['inTime'])/3600);
            echo "<tr>";
            echo "<td>" . $reg . "</td>";
            ...
            if ($rows[$x]['outTime'] != NULL) { echo "<td>" . $hoursused  . "</td>"; }  
            else { echo"<td>" . "" . "</td>";}
