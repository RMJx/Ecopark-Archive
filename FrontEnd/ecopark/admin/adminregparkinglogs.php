...
$url = "https://rjohnston80.webhosting3.eeecs.qub.ac.uk/parkingapi/?function=parkinghistoryreg&id=" . $_REQUEST['reg'] . "&username=" . $_REQUEST['username'] . "&adminusername=" . $adminUsername . 
"&API-KEY=" . $APIKey;
$curl = curl_init($url);
...
<head>
    ...
    <meta charset="utf-8">
    <title>Ecopark - Admin Logs</title>
...
<main class="l-main">
    <div class="content-wrapper content-wrapper--with-bg">
        <div class="page-content">Please find parking history below for specific user. Photos of parking session entry and exit are available to access.</em>
            <?php $total = 0;
          if (is_array($locationlogs)==0) { echo "<h4>There is no parking history, once parking happens you will see all parking logs here. </h4>"; }
          else {
        ...
        <?php 
          ...
          $usernamegraph = $locationlogs[0]['userName'];
